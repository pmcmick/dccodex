...
function resolveDccodexHome() {
  if (process.env.DCCODEX_HOME && process.env.DCCODEX_HOME.trim()) {
    return process.env.DCCODEX_HOME;
  }
  return path.join(homedir(), ".dccodex");
}
...
const dccodexHome = resolveDccodexHome();
env.DCCODEX_HOME = dccodexHome;
env.CODEX_HOME = dccodexHome;
